			...
			<txp:oui_cookie name='<txp:site_name trim="/\s+/" replace="_" />_mixcloud_cookie' duration="+1 year" values="yes" />
				...
				<txp:else />
					<div class="gdpr">
						<txp:if_yield name="title"><txp:yield name="title" escape="textile" /></txp:if_yield>
						<txp:if_yield name="url">
							<p>Hosted by Mixcloud on <a rel="external noopener" href="https://www.mixcloud.com/<txp:yield name="url" />/txp:yield name="media" />mixcloud.com/<txp:yield name="url" />/txp:yield name="media" />/">mixcloud.com/<txp:yield name="url" />/txp:yield name="media" />mixcloud.com/<txp:yield name="url" />/txp:yield name="media" />/</a>.</p>
